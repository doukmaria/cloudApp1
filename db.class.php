<?php
  ...
  class DB
  {
    ...
    function DB($base, $server, $user, $pass)
    {
      ...
      mysql_connect($server, $user, $pass) or die('Server connection is not possible.'.$user.$pass.$server);
      mysql_select_db($base)               or die('Database connection is not possible.');
    }
